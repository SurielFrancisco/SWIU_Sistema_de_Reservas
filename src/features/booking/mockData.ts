...
export const MOCK_TABLES: TableInfo[] = [
  ...
  { id: 'T-02', label: 'T-02', capacity: 4, status: 'occupied', shape: 'round-4', position: { x: 40, y: 25 } },
  ...
  { id: 'G-12', label: 'G-12', capacity: 2, status: 'reserved', shape: 'square-2', position: { x: 50, y: 50 } },
  ...
  { id: 'V-02', label: 'V-02', capacity: 4, status: 'occupied', shape: 'square-4', position: { x: 40, y: 75 } },
